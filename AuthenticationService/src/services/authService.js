    ...
    if (foundUser.status === HttpStatus.OK) {
        ...
        if (retrivedUser) {
            ...
            if (checkPswMatch === true) {
                 ...
                 const accessToken = getAccessToken(retrivedUser._id,retrivedUser.userRole, retrivedUser.userName)
                 const refreshToken = getRefreshToken(retrivedUser._id,retrivedUser.userRole, retrivedUser.userName)
